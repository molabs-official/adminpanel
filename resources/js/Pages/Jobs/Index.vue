...
<!--- more free and premium Tailwind CSS components at https://tailwinduikit.com/ --->
            <div class="px-4 py-4 md:px-10 md:py-7">
                <div class="flex items-center justify-between">
                    <p tabindex="0" class="text-base font-bold leading-normal text-gray-800 focus:outline-none sm:text-lg md:text-xl lg:text-2xl">Tasks</p>
                        ...
                        <tbody>
                            ...
                            <tr tabindex="0" class="h-16 border border-gray-100 rounded focus:outline-none">
                                ...
                                <td  class="focus:text-indigo-600 ">
                                    <div class="flex items-center pl-5">
                                        <p class="mr-2 text-base font-medium leading-none text-gray-700">UX Wireframes</p>
                                    </div>
                                </td>
                                <td class="pl-24">
                                    <div class="flex items-center">
                                ...
                                <td class="pl-5">
                                    <button class="px-6 py-3 text-sm leading-none text-gray-700 bg-gray-100 rounded focus:outline-none">Due on 21.02.21</button>
                                </td>
                                <td class="pl-4">
                                    <button class="px-5 py-3 text-sm leading-none text-gray-600 bg-gray-100 rounded focus:ring-2 focus:ring-offset-2 focus:ring-red-300 hover:bg-gray-200 focus:outline-none">View</button>
                                </td>
                            ...
                            <tr class="h-3"></tr>
                            <tr tabindex="0" class="h-16 border border-gray-100 rounded focus:outline-none focus:text-indigo-600">
                                <td>
                                    <div class="ml-5">
                                        <div class="relative flex items-center justify-center flex-shrink-0 w-5 h-5 bg-gray-200 rounded-sm">
                                            <input placeholder="checkbox" type="checkbox" class="absolute w-full h-full opacity-0 cursor-pointer focus:opacity-100 checkbox" />
                                ...
                                <td class="pl-5">
                                    <button class="py-3 text-sm leading-none text-gray-700 bg-gray-100 rounded px-7 focus:outline-none">Due tomorrow</button>
                                </td>
                                <td class="pl-4">
                                    <button class="px-5 py-3 text-sm leading-none text-gray-600 bg-gray-100 rounded focus:ring-2 focus:ring-offset-2 focus:ring-red-300 hover:bg-gray-200 focus:outline-none">View</button>
                                </td>
                            ...
                            <tr tabindex="0" class="h-16 border border-gray-100 rounded focus:outline-none">
                                <td>
                                    <div class="ml-5">
                                        <div class="relative flex items-center justify-center flex-shrink-0 w-5 h-5 bg-gray-200 rounded-sm">
                                            <input placeholder="checkbox" checked="" type="checkbox" class="absolute w-full h-full opacity-0 cursor-pointer focus:opacity-100 checkbox" />
                                            <div class="hidden text-white bg-indigo-700 rounded-sm check-icon">
                                                <svg class="icon icon-tabler icon-tabler-check" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                                    <path stroke="none" d="M0 0h24v24H0z"></path>
                                                    <path d="M5 12l5 5l10 -10"></path>
                                ...
                                <td class="">
                                    <div class="flex items-center pl-5">
                                        <p class="mr-2 text-base font-medium leading-none text-gray-700">Development Phase 1</p>
                                    </div>
                                </td>
                                <td class="pl-24"></td>
                                <td class="pl-5"></td>
                                ...
                                <td>
                                    <div class="relative px-5 pt-2">
                                        ...
                                        <div class="absolute right-0 z-30 hidden w-24 mr-6 bg-white shadow dropdown-content">
                                            <div tabindex="0" class="w-full px-4 py-4 text-xs cursor-pointer focus:outline-none focus:text-red-300 hover:bg-indigo-700 hover:text-white">
                                                <p>Edit</p>
                                            </div>
                                            <div tabindex="0" class="w-full px-4 py-4 text-xs cursor-pointer focus:outline-none focus:text-red-300 hover:bg-indigo-700 hover:text-white">
                                                <p>Delete</p>
                            ...
                            <tr tabindex="0" class="h-16 border border-gray-100 rounded focus:outline-none">
                                ...
                                <td class="">
                                    <div class="flex items-center pl-5">
                                        <p class="mr-2 text-base font-medium leading-none text-gray-700">CSS and functionality</p>
                                    </div>
                                </td>
                                <td class="pl-24">
                                    <div class="flex items-center">
                            ...
                            <tr tabindex="0" class="h-16 border border-gray-100 rounded focus:outline-none">
                                <td>
                                    <div class="ml-5">
                                        <div class="relative flex items-center justify-center flex-shrink-0 w-5 h-5 bg-gray-200 rounded-sm">
                                            <input placeholder="checkbox" checked="" type="checkbox" class="absolute w-full h-full opacity-0 cursor-pointer checkbox" />
                                            <div class="hidden text-white bg-indigo-700 rounded-sm check-icon">
                                                <svg class="icon icon-tabler icon-tabler-check" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                                    <path stroke="none" d="M0 0h24v24H0z"></path>
                                                    <path d="M5 12l5 5l10 -10"></path>
                            ...
                            <tr tabindex="0" class="h-16 border border-gray-100 rounded focus:outline-none">
                                ...
                                <td class="pl-5">
                                    <button class="px-3 py-3 text-sm leading-none text-gray-700 bg-gray-100 rounded hover:bg-gray-200 focus:outline-none">Due Today at 18:00</button>
                                </td>
                                <td class="pl-4">
                                    <button class="px-5 py-3 text-sm leading-none text-gray-600 bg-gray-100 rounded focus:ring-2 focus:ring-offset-2 focus:ring-red-300 hover:bg-gray-200 focus:outline-none">View</button>
                                </td>

...
<div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
        ...
        <div class="md:grid md:grid-cols-3 md:gap-6">
          ...
          >
            <ul class="flex pb-3 space-x-10 font-semibold uppercase border-b-4">
              ...
              <li>
                <Link
                :class="{'active border-b-4 border-red-500 text-gray-900': $page.component === 'Employees/Emport'}"
                  class="
                    transition
                    duration-150
                    ease-in
          ...
          <div class="mt-5 md:mt-0 md:col-span-2">
            <div class="flex flex-col justify-center w-full sm:px-6">

      <main class="container h-full max-w-screen-lg mx-auto">
        <!-- file upload modal -->
        <article aria-label="File Upload Modal" class="relative flex flex-col h-full bg-white rounded-md shadow-xl" ondrop="dropHandler(event);" ondragover="dragOverHandler(event);" ondragleave="dragLeaveHandler(event);" ondragenter="dragEnterHandler(event);">
          <!-- overlay -->
          <div id="overlay" class="absolute top-0 left-0 z-50 flex flex-col items-center justify-center w-full h-full rounded-md pointer-events-none">
            <i>
              <svg class="w-12 h-12 mb-3 text-blue-700 fill-current" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
          ...
          <section class="flex flex-col w-full h-full p-8 overflow-auto">
            ...
            <ul id="gallery" class="flex flex-wrap flex-1 -m-1">
              <li id="empty" class="flex flex-col items-center justify-center w-full h-full text-center">
                <img class="w-32 mx-auto" src="https://user-images.githubusercontent.com/507615/54591670-ac0a0180-4a65-11e9-846c-e55ffce0fe7b.png" alt="no data" />
    ...
    <template id="file-template">
      <li class="block w-1/2 h-24 p-1 sm:w-1/3 md:w-1/4 lg:w-1/6 xl:w-1/8">
        <article tabindex="0" class="relative w-full h-full bg-gray-100 rounded-md shadow-sm cursor-pointer group focus:outline-none focus:shadow-outline elative">
          <img alt="upload preview" class="sticky hidden object-cover w-full h-full bg-fixed rounded-md img-preview" />
          ...
          <section class="absolute top-0 z-20 flex flex-col w-full h-full px-3 py-2 text-xs break-words rounded-md">
            ...
            <div class="flex">
              <span class="p-1 text-blue-800">
                <i>
                  <svg class="w-4 h-4 pt-1 ml-auto fill-current" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
              ...
              <button class="p-1 ml-auto text-gray-800 rounded-md delete focus:outline-none hover:bg-gray-300">
                <svg class="w-4 h-4 ml-auto pointer-events-none fill-current" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
    ...
    <template id="image-template">
      <li class="block w-1/2 h-24 p-1 sm:w-1/3 md:w-1/4 lg:w-1/6 xl:w-1/8">
        <article tabindex="0" class="relative w-full h-full text-transparent bg-gray-100 rounded-md shadow-sm cursor-pointer group hasImage focus:outline-none focus:shadow-outline hover:text-white">
          ...
          <section class="absolute top-0 z-20 flex flex-col w-full h-full px-3 py-2 text-xs break-words rounded-md">
            ...
            <div class="flex">
              <span class="p-1">
                <i>
                  <svg class="w-4 h-4 ml-auto fill-current pt-" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">

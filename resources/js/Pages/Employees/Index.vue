          ...
          <div class="overflow-hidden shadow ring-1 ring-black ring-opacity-5 md:rounded-lg">
            <table class="min-w-full">
              ...
              <tbody class="bg-white">
                <template v-for="team in teams.data" :key="team.team_name">
                  <tr class="border-t border-gray-200">
                    <th colspan="5" scope="colgroup" class="px-4 py-2 text-sm font-semibold text-left text-white bg-red-500 sm:px-6">{{ team.team_name }}</th>
                  </tr>
